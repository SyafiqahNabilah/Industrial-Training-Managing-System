...
<div id="wrapper">
        <div class="navbar-default sidebar" role="navigation">
        	...
        	<center><a href="index.php"><img style="width: 130px;" src="src/logo.png" ></a></center>
        	</ul>
   		 </div>
		</div>
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
		<h2 class="page-header">Senarai Pelajar berserta PP,PPO dan PO </h2>
	<div class = "alert alert-info">
		Sila gunakan ruangan carian dibawah untuk memudahkan pencarian maklumat
	</div>
<br><br/>
