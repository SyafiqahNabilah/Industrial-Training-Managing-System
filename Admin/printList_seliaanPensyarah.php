<?php 
  include '..\dbcon.php';
     if (isset($_GET['filterPensyarah'])) {
    $id = $_GET['filterPensyarah'];
...
<br>
  ...
  $idpensyarah = $row['IDPensyarahPP'];
    $seliaan = "SELECT ojt_pelajar.namaPelajar , ojt_industri.namaSyarikat, ojt_industri.Alamat, ojt_penyelia_industri.namaPenyelia, ojt_penyelia_industri.notel,ojt_industri.Alamat2,ojt_industri.Poskod, ojt_industri.Daerah,ojt_industri.Negeri,ojt_pelajar.program,ojt_pelajar.notelpelajar
    FROM ref_seliaan
  ...
  <table class="table table-striped table-bordered table-hover" id="myData">
    ...
    <?php if ($rows = mysqli_fetch_array($Hasil)) {?>
    <tbody>
        <td>
          <?php echo $num++ ?>
        </td>
    ...
    <br>
  <div align="right"><input type="button" value="cetak senarai" id="printpage" onclick="printpage()"></div>
    <script>
    function printpage() {
