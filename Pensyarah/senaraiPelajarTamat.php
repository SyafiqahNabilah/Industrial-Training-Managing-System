...
<div class="row">
	<div class="col-lg-12">
		...
		Memaparkan senarai pelajar yang sedang menjalankan OJT. Klik pada "Maklumat Pelajar" untuk melihat maklumat peribadi pelajar.<br><br/>
		<?php 	$sql2 = "SELECT ojt_pelajar.namaPelajar , ojt_pelajar.nokpPelajar , ojt_pelajar.notelPelajar,ojt_pelajar.Kohort,ref_seliaan.Status,ref_seliaan.TahunSeliaan,ojt_pelajar.program,ojt_pelajar.kelas
						  	FROM ref_seliaan
