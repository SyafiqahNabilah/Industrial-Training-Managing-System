...
if (isset($_GET['kemaskiniSeliaan'])) {
	$nokp = $_GET['kemaskiniSeliaan'];
	$sql = "SELECT ojt_pelajar.namaPelajar, ojt_pelajar.kelas,ojt_pelajar.nokpPelajar, ojt_pensyarah.namaPensyarah AS Pensyarah1 ,ojt_industri.namaSyarikat, ojt_penyelia_industri.namaPenyelia,ref_seliaan.IDPensyarahPP,ojt_industri.IDIndustri,ref_seliaan.IDPenyelia
		   	FROM `ref_seliaan`
...
<center><button type="submit" class="btn btn-default" name="kemaskiniSeliaanPenyelaras">KEMASKINI</button></center>
<br>
</form>
<?php } }?>
<br>
